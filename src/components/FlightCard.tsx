...
export default function FlightCard({flight, to, from, date}) {
    ...
    const handleChange = (type:string, e:any):void => {
        if (type == 'adult') {
    ...
    const handleClick = () => {
        ...
        const params:any = {to, from, date, adult, child, infant, flight: flight.flight_code}
        ...
        <div className="flight-info">
            ...
            <div className="flight-info-right">
                <div className='flight-fare'>
                    {IDR.format(flight.flight_price)}
                </div>
                <div className=' with-icon flught_seatavail'>
                    Seats available
                ...
                <div className="flight-form">
                    ...
                    <div className="passenger-form infant-form">
                        <button className="buy-ticket-btn" onClick={handleClick}>Go!</button>
                    </div>
                </div>
